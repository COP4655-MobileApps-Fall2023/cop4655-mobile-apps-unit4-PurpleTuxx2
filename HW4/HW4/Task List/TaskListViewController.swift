...
extension TaskListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Add a visual indicator if the task is completed
        if task.isComplete {
            cell.backgroundColor = UIColor.green // Example: turn the cell background green
        } else {
            cell.backgroundColor = UIColor.white // Example: keep it white if not completed
        }
